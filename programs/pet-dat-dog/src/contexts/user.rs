// //  the user context initializes or reads the existing account for the user for the dog.
// // the user context mutates the Dog account, the User account, and the petsboard, or bonkboard of the Dog
// // the user context also might be responsible for the vault paying out its members
